...
export default function EditTicketScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('Error', error instanceof Error ? error.message : 'Failed to update ticket');
    } finally {
      setSaving(false);
    }
  };
    ...
    >
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <ThemedText type="title">Edit Service Ticket</ThemedText>
        ...
        <View style={styles.section}>
          ...
          >
            <ThemedText>
              Date Delivered: {dateDelivered ? dateDelivered.toLocaleDateString('ro-RO') : 'Not set'}
            </ThemedText>
          </Pressable>
